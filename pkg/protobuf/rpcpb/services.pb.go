...
var file_rpcpb_services_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x32, 0xdc, 0x0d, 0x0a, 0x07, 0x4d, 0x6f, 0x6e, 0x61,
	...
	,
	...
	0x0f, 0x2e, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x70, 0x62, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79,
	0x1a, 0x0e, 0x2e, 0x72, 0x70, 0x63, 0x70, 0x62, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x22, 0x00, 0x30, 0x01, 0x12, 0x30, 0x0a, 0x0b, 0x53, 0x65, 0x6e, 0x64, 0x4d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x12, 0x0e, 0x2e, 0x72, 0x70, 0x63, 0x70, 0x62, 0x2e, 0x4d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x1a, 0x0f, 0x2e, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x70, 0x62, 0x2e, 0x45,
...
var file_rpcpb_services_proto_depIdxs = []int32{
	...
	20, // 29: rpcpb.Monarch.StageLocal:input_type -> clientpb.StageLocalRequest
	21, // 30: rpcpb.Monarch.Unstage:input_type -> clientpb.UnstageRequest
	14, // 31: rpcpb.Monarch.Notify:input_type -> clientpb.Empty
	14, // 32: rpcpb.Monarch.GetMessages:input_type -> clientpb.Empty
	2,  // 33: rpcpb.Monarch.SendMessage:input_type -> rpcpb.Message
	22, // 34: rpcpb.Builder.GetCommands:output_type -> builderpb.DescriptionsReply
	23, // 35: rpcpb.Builder.GetOptions:output_type -> builderpb.OptionsReply
	24, // 36: rpcpb.Builder.BuildAgent:output_type -> builderpb.BuildReply
	25, // 37: rpcpb.Monarch.Players:output_type -> clientpb.Players
	26, // 38: rpcpb.Monarch.Agents:output_type -> clientpb.Agents
	14, // 39: rpcpb.Monarch.NewAgent:output_type -> clientpb.Empty
	14, // 40: rpcpb.Monarch.RmAgents:output_type -> clientpb.Empty
	27, // 41: rpcpb.Monarch.Builders:output_type -> clientpb.Builders
	28, // 42: rpcpb.Monarch.Profiles:output_type -> clientpb.Profiles
	14, // 43: rpcpb.Monarch.SaveProfile:output_type -> clientpb.Empty
	29, // 44: rpcpb.Monarch.LoadProfile:output_type -> clientpb.ProfileData
	14, // 45: rpcpb.Monarch.RmProfiles:output_type -> clientpb.Empty
	23, // 46: rpcpb.Monarch.Options:output_type -> builderpb.OptionsReply
	30, // 47: rpcpb.Monarch.Build:output_type -> clientpb.BuildReply
	14, // 48: rpcpb.Monarch.EndBuild:output_type -> clientpb.Empty
	1,  // 49: rpcpb.Monarch.Install:output_type -> rpcpb.Notification
	1,  // 50: rpcpb.Monarch.Uninstall:output_type -> rpcpb.Notification
	1,  // 51: rpcpb.Monarch.HttpOpen:output_type -> rpcpb.Notification
	14, // 52: rpcpb.Monarch.HttpClose:output_type -> clientpb.Empty
	1,  // 53: rpcpb.Monarch.HttpsOpen:output_type -> rpcpb.Notification
	14, // 54: rpcpb.Monarch.HttpsClose:output_type -> clientpb.Empty
	31, // 55: rpcpb.Monarch.Sessions:output_type -> clientpb.Sessions
	14, // 56: rpcpb.Monarch.LockSession:output_type -> clientpb.Empty
	14, // 57: rpcpb.Monarch.FreeSession:output_type -> clientpb.Empty
	22, // 58: rpcpb.Monarch.Commands:output_type -> builderpb.DescriptionsReply
	32, // 59: rpcpb.Monarch.Send:output_type -> clientpb.HTTPResponse
	33, // 60: rpcpb.Monarch.StageView:output_type -> clientpb.Stage
	1,  // 61: rpcpb.Monarch.StageAdd:output_type -> rpcpb.Notification
	1,  // 62: rpcpb.Monarch.StageLocal:output_type -> rpcpb.Notification
	14, // 63: rpcpb.Monarch.Unstage:output_type -> clientpb.Empty
	1,  // 64: rpcpb.Monarch.Notify:output_type -> rpcpb.Notification
	2,  // 65: rpcpb.Monarch.GetMessages:output_type -> rpcpb.Message
	14, // 66: rpcpb.Monarch.SendMessage:output_type -> clientpb.Empty
