...
var file_rpcpb_services_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x32, 0xbf, 0x0e, 0x0a, 0x07, 0x4d, 0x6f, 0x6e, 0x61,
	...
	,
...
var file_rpcpb_services_proto_depIdxs = []int32{
	...
	16, // 25: rpcpb.Monarch.LockSession:input_type -> clientpb.LockSessionRequest
	17, // 26: rpcpb.Monarch.FreeSession:input_type -> clientpb.FreeSessionRequest
	3,  // 27: rpcpb.Monarch.Commands:input_type -> builderpb.DescriptionsRequest
	18, // 28: rpcpb.Monarch.Send:input_type -> clientpb.HTTPRequest
	14, // 29: rpcpb.Monarch.StageView:input_type -> clientpb.Empty
	19, // 30: rpcpb.Monarch.StageAdd:input_type -> clientpb.StageAddRequest
	20, // 31: rpcpb.Monarch.StageLocal:input_type -> clientpb.StageLocalRequest
	21, // 32: rpcpb.Monarch.Unstage:input_type -> clientpb.UnstageRequest
	14, // 33: rpcpb.Monarch.Notify:input_type -> clientpb.Empty
	14, // 34: rpcpb.Monarch.GetMessages:input_type -> clientpb.Empty
	2,  // 35: rpcpb.Monarch.SendMessage:input_type -> rpcpb.Message
	22, // 36: rpcpb.Builder.GetCommands:output_type -> builderpb.DescriptionsReply
	23, // 37: rpcpb.Builder.GetOptions:output_type -> builderpb.OptionsReply
	24, // 38: rpcpb.Builder.BuildAgent:output_type -> builderpb.BuildReply
	25, // 39: rpcpb.Monarch.Players:output_type -> clientpb.Players
	26, // 40: rpcpb.Monarch.Agents:output_type -> clientpb.Agents
	14, // 41: rpcpb.Monarch.NewAgent:output_type -> clientpb.Empty
	14, // 42: rpcpb.Monarch.RmAgents:output_type -> clientpb.Empty
	27, // 43: rpcpb.Monarch.Builders:output_type -> clientpb.Builders
	28, // 44: rpcpb.Monarch.Profiles:output_type -> clientpb.Profiles
	14, // 45: rpcpb.Monarch.SaveProfile:output_type -> clientpb.Empty
	29, // 46: rpcpb.Monarch.LoadProfile:output_type -> clientpb.ProfileData
	14, // 47: rpcpb.Monarch.RmProfiles:output_type -> clientpb.Empty
	23, // 48: rpcpb.Monarch.Options:output_type -> builderpb.OptionsReply
	30, // 49: rpcpb.Monarch.Build:output_type -> clientpb.BuildReply
	14, // 50: rpcpb.Monarch.EndBuild:output_type -> clientpb.Empty
	1,  // 51: rpcpb.Monarch.Install:output_type -> rpcpb.Notification
	1,  // 52: rpcpb.Monarch.Uninstall:output_type -> rpcpb.Notification
	1,  // 53: rpcpb.Monarch.HttpOpen:output_type -> rpcpb.Notification
	14, // 54: rpcpb.Monarch.HttpClose:output_type -> clientpb.Empty
	1,  // 55: rpcpb.Monarch.HttpsOpen:output_type -> rpcpb.Notification
	14, // 56: rpcpb.Monarch.HttpsClose:output_type -> clientpb.Empty
	1,  // 57: rpcpb.Monarch.TcpOpen:output_type -> rpcpb.Notification
	14, // 58: rpcpb.Monarch.TcpClose:output_type -> clientpb.Empty
	31, // 59: rpcpb.Monarch.Sessions:output_type -> clientpb.Sessions
	14, // 60: rpcpb.Monarch.LockSession:output_type -> clientpb.Empty
	14, // 61: rpcpb.Monarch.FreeSession:output_type -> clientpb.Empty
	22, // 62: rpcpb.Monarch.Commands:output_type -> builderpb.DescriptionsReply
	32, // 63: rpcpb.Monarch.Send:output_type -> clientpb.HTTPResponse
	33, // 64: rpcpb.Monarch.StageView:output_type -> clientpb.Stage
	1,  // 65: rpcpb.Monarch.StageAdd:output_type -> rpcpb.Notification
	1,  // 66: rpcpb.Monarch.StageLocal:output_type -> rpcpb.Notification
	14, // 67: rpcpb.Monarch.Unstage:output_type -> clientpb.Empty
	1,  // 68: rpcpb.Monarch.Notify:output_type -> rpcpb.Notification
	2,  // 69: rpcpb.Monarch.GetMessages:output_type -> rpcpb.Message
	14, // 70: rpcpb.Monarch.SendMessage:output_type -> clientpb.Empty
