...
func (InstallRequest_Source) EnumDescriptor() ([]byte, []int) {
	return file_clientpb_client_proto_rawDescGZIP(), []int{7, 0}
}
...
func (ResponseDetail_Dest) EnumDescriptor() ([]byte, []int) {
	return file_clientpb_client_proto_rawDescGZIP(), []int{18, 0}
}
...
func (x *NotifyRequest) GetPlayerId() string {
	if x != nil {
		return x.PlayerId
	}
	return ""
...
func (x *NotifyRequest) GetPlayerName() string {
	if x != nil {
		return x.PlayerName
	}
	return ""
...
var file_clientpb_client_proto_rawDesc = []byte{
	...
	0x72, 0x52, 0x08, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x73, 0x22, 0x29, 0x0a, 0x0c, 0x41,
	...
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x4d, 0x0a, 0x0d, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79,
...
var file_clientpb_client_proto_goTypes = []interface{}{
	...
	(*AgentRequest)(nil),       // 5: clientpb.AgentRequest
	(*Agent)(nil),              // 6: clientpb.Agent
	(*Agents)(nil),             // 7: clientpb.Agents
	(*ProfileRequest)(nil),     // 8: clientpb.ProfileRequest
	(*InstallRequest)(nil),     // 9: clientpb.InstallRequest
	(*UninstallRequest)(nil),   // 10: clientpb.UninstallRequest
	(*ProfileRecord)(nil),      // 11: clientpb.ProfileRecord
	(*Profile)(nil),            // 12: clientpb.Profile
	(*Profiles)(nil),           // 13: clientpb.Profiles
	(*SaveProfileRequest)(nil), // 14: clientpb.SaveProfileRequest
	(*ProfileData)(nil),        // 15: clientpb.ProfileData
	(*SessionsRequest)(nil),    // 16: clientpb.SessionsRequest
	(*Session)(nil),            // 17: clientpb.Session
	(*Sessions)(nil),           // 18: clientpb.Sessions
	(*HTTPRequest)(nil),        // 19: clientpb.HTTPRequest
	(*ResponseDetail)(nil),     // 20: clientpb.ResponseDetail
...
var file_clientpb_client_proto_depIdxs = []int32{
	...
	6,  // 1: clientpb.Agents.agents:type_name -> clientpb.Agent
